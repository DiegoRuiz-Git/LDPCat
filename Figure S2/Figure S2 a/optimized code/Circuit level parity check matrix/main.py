...
# physical error rate during measurement
q = p
...
for i in range(fractalcode.circuit.nbcol):
    for j in range(fractalcode.circuit.columns[i].nbgates):
        if fractalcode.circuit.columns[i].gates[j].name == "I":
            nb_pauli_errors += 1
        if fractalcode.circuit.columns[i].gates[j].name == "MX":
            nb_pauli_errors += 1
...
for i in range(fractalcode.circuit.nbcol):
    ...
    for j in range(column.nbgates):
        ...
        if gate.name == "I" or gate.name == "MX":
